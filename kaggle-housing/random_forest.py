...
class RandomForest(IModel):
    ...
    def predict(self, x, x_test):
        ...
        logging.info(f"Random tree validation MAE: {mean_absolute_error(np.exp(y_valid), np.exp(prediction))}")
        ...
        test_pred.to_csv('submissions\\submission_random.csv', index=False)
